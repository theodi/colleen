...
--
-- Table structure for table `analytics_test`
--
...
--
-- Table structure for table `timeseries_test`
--
CREATE TABLE IF NOT EXISTS `timeseries_test` (
  `type_id` varchar(1) NOT NULL DEFAULT '',
...
--
-- Table structure for table `classifications_test`
--

CREATE TABLE IF NOT EXISTS `classifications_test` (
...
LOCK TABLES `projects_test` WRITE;
/*!40000 ALTER TABLE `projects_test` DISABLE KEYS */;

INSERT INTO `projects_test` (`id`, `name`, `display_name`, `updated`)
VALUES
...
/*!40000 ALTER TABLE `projects_test` ENABLE KEYS */;
UNLOCK TABLES;
